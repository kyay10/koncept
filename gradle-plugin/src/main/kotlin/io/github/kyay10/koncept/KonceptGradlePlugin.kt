...
class KonceptGradlePlugin : KotlinCompilerPluginSupportPlugin {
  override fun apply(target: Project): Unit = with(target) {
    extensions.create("koncept", KonceptGradleExtension::class.java)
  }
  ...
  override fun applyToCompilation(
    ...
    val extension = project.extensions.getByType(KonceptGradleExtension::class.java)
